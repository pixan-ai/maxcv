      ...
      <div className="max-w-2xl mx-auto px-5 py-3.5 flex flex-col gap-1">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-[family-name:var(--font-geist)] text-lg font-medium leading-none text-ink-900">maxcv</span>
          </Link>
          <span className="hidden sm:block text-[11px] text-ink-300">{t.powered}</span>
        ...
        <span className="sm:hidden text-[10px] text-ink-300 text-center">{t.powered}</span>
      </div>
    </header>
  );
}
