...
const TEXT = {
  en: {
    headline: "maxcv helped? Keep it free for everyone.",
    sub: "Donations cover AI costs — every bit helps keep this running.",
    stripe: "Support with card",
    paypal: "PayPal",
  },
  es: {
    headline: "¿Te ayudó maxcv? Mantenlo gratis para todos.",
    sub: "Las donaciones cubren costos de IA — cada aporte ayuda.",
    ...
    <div className="bg-[--ink-050] rounded-xl p-6 text-center space-y-3">
      ...
      <div className="flex items-center justify-center gap-3 pt-1">
        ...
        <a href={PAYPAL_LINK} target="_blank" rel="noopener noreferrer"
          className="text-sm text-[--ink-400] hover:text-[--ink-700] font-medium transition">
          {t.paypal}
        </a>
      </div>
    </div>
